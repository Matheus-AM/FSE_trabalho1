...
void write_uart_get(int filestream, unsigned char code) {
  unsigned char package[7] = {0x01, 0x23, code, 0x00,
                              0x03, 0x00, 0x07};
...
void write_uart_send(int filestream, int control_signal, unsigned char code) {
  unsigned char package[7] = {0x01, 0x16, code, 0x00,
                              0x03, 0x00, 0x07};
